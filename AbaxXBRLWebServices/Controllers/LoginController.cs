...
namespace AbaxXBRLWeb.Controllers
{
    ...
    public class LoginController : BaseController
    {
        ...
        private void IniciaParametrosConfiguracionVista()
        {
            ...
            param = ConfigurationManager.AppSettings.Get("LISENCIA_FIDEICOMISO");
        ...
        [HttpPost]
        [AllowAnonymous]
        [Route("CambioPassword/{idUsuario}/{passwordAnterior}/{passwordNuevo}/{passwordConfirmar}")]
        public IHttpActionResult CambioPassword(long idUsuario, string passwordAnterior, string passwordNuevo, string passwordConfirmar)
        {
