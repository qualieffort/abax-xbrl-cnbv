...
module abaxXBRL.templates.extensions {
    ...
    /**
       ...
       * @version 1.0
       */
    export class XbrlEstadoVariacionesCapitalContableCNBVController {
        ...
        public static get ESPACIO_NOMBRES_DIMENSION_COMPONENTE_MX(): string { return 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05'; }
        ...
        private $scope: IXbrlEstadoVariacionesCapitalContableControllerCNBVScope;
        ...
        **/
        ...
        private init(): void {
            ...
            this.$scope.informacionDimensiones = new InformacionDimensionesEVCC_CNBV(documentoInstancia);
            ...
            this.$scope.informacionDimensiones.fechaReporte = XbrlEstadoVariacionesCapitalContableCNBVController.FECHA_REPORTE_ACTUAL;
            self.$scope.informacionDimensiones.temporalFecha = XbrlEstadoVariacionesCapitalContableCNBVController.FECHA_REPORTE_ACTUAL;
                    ...
                    for (var jdx = 0; jdx < hechosARevisar.length; jdx++) {
                        ...
                        if (contextoARevisar.ContieneInformacionDimensional && contextoARevisar.ValoresDimension && contextoARevisar.ValoresDimension.length) {
                            ...
                            for (var kdx = 0; kdx < contextoARevisar.ValoresDimension.length; kdx++) {
                                if (contextoARevisar.ValoresDimension[kdx].QNameDimension === XbrlEstadoVariacionesCapitalContableCNBVController.QNAME_DIMENSION_COMPONENTES_CAPITAL_CONTABLE) {
                                    contieneMiembroDimensionComponentesCapitalContable = true;
                                }
                                if (contextoARevisar.ValoresDimension[kdx].QNameDimension === XbrlEstadoVariacionesCapitalContableCNBVController.QNAME_DIMENSION_APLICACION_RETROACTIVA) {
            ...
            this.$scope.generarContextosNecesarios = function (): void {
                ...
                if (self.$scope.informacionDimensiones.temporalFecha === XbrlEstadoVariacionesCapitalContableCNBVController.FECHA_REPORTE_ACTUAL) {
                ...
                } else if (self.$scope.informacionDimensiones.temporalFecha === XbrlEstadoVariacionesCapitalContableCNBVController.FECHA_REPORTE_ANTERIOR) {
            ...
            this.$scope.establecerFechaDeReporte = function (): void {
                ...
                shared.service.AbaxXBRLUtilsService.setTimeout(function () {
                    ...
                    if (self.$scope.informacionDimensiones.fechaReporte === XbrlEstadoVariacionesCapitalContableCNBVController.FECHA_REPORTE_ACTUAL) {
                        self.$scope.fechaInicioEjercicio = definicionPlantilla.obtenerVariablePorId('fecha_2015_01_01');
                        self.$scope.fechaFinTrimestre = definicionPlantilla.obtenerVariablePorId('fecha_2015_09_30');
                        self.$scope.fechaFinEjercicioAnterior = definicionPlantilla.obtenerVariablePorId('fecha_2014_12_31');
                    } else if (self.$scope.informacionDimensiones.fechaReporte === XbrlEstadoVariacionesCapitalContableCNBVController.FECHA_REPORTE_ANTERIOR) {
            ...
            this.$scope.obtenerIdContexto = function (idMiembroComponenteCapitalContable: string, idMiembroAplicacionRetroactiva: string, tipo: number, fechaInicio: string, fechaFin?: string): string {
                ...
                var qNameMiembroComponenteCapitalContable = XbrlEstadoVariacionesCapitalContableCNBVController.ESPACIO_NOMRES_DIMENSION_COMPONENTES_CAPITAL_CONTABLE + abaxXBRL.model.ConstantesComunes.SEPARADOR_NOMBRE_CALIFICADO + nameMiembroComponenteCapitalContable;
                if (nameMiembroComponenteCapitalContable === "OtrosResultadosIntegralesMiembro") {
                    qNameMiembroComponenteCapitalContable = XbrlEstadoVariacionesCapitalContableCNBVController.ESPACIO_NOMBRES_DIMENSION_COMPONENTE_MX + abaxXBRL.model.ConstantesComunes.SEPARADOR_NOMBRE_CALIFICADO + nameMiembroComponenteCapitalContable;
                }
                var qNameMiembroAplicacionRetroactiva = XbrlEstadoVariacionesCapitalContableCNBVController.ESPACIO_NOMRES_DIMENSION_APLICACION_RETROACTIVA + abaxXBRL.model.ConstantesComunes.SEPARADOR_NOMBRE_CALIFICADO + nameMiembroAplicacionRetroactiva;
                var idMiembroComponenteCapitalContable = XbrlEstadoVariacionesCapitalContableCNBVController.PREFIJO_ID_MIEMBRO_DIMENSION + nameMiembroComponenteCapitalContable;
                if (nameMiembroComponenteCapitalContable === "OtrosResultadosIntegralesMiembro") {
                    idMiembroComponenteCapitalContable = XbrlEstadoVariacionesCapitalContableCNBVController.PREFIJO_ID_MIEMBRO_MX + nameMiembroComponenteCapitalContable;
                }
                var idMiembroAplicacionRetroactiva = XbrlEstadoVariacionesCapitalContableCNBVController.PREFIJO_ID_MIEMBRO_DIMENSION + nameMiembroAplicacionRetroactiva;
                ...
                if (qNameMiembroAplicacionRetroactiva !== XbrlEstadoVariacionesCapitalContableCNBVController.QNAME_MIEMBRO_DEFAULT_APLICACION_RETROACTIVA) {
                    valoresDimensionABuscar.push({
                        qNameDimension: XbrlEstadoVariacionesCapitalContableCNBVController.QNAME_DIMENSION_APLICACION_RETROACTIVA,
                        qNameItemMiembroDimension: qNameMiembroAplicacionRetroactiva,
                        idDimension: XbrlEstadoVariacionesCapitalContableCNBVController.ID_DIMENSION_APLICACION_RETROACTIVA,
                        idItemMiembro: idMiembroAplicacionRetroactiva
                    });
                }
                if (qNameMiembroComponenteCapitalContable !== XbrlEstadoVariacionesCapitalContableCNBVController.QNAME_MIEMBRO_DEFAULT_COMPONENTES_CAPITAL_CONTABLE) {
                    valoresDimensionABuscar.push({
                        qNameDimension: XbrlEstadoVariacionesCapitalContableCNBVController.QNAME_DIMENSION_COMPONENTES_CAPITAL_CONTABLE,
                        qNameItemMiembroDimension: qNameMiembroComponenteCapitalContable,
                        idDimension: XbrlEstadoVariacionesCapitalContableCNBVController.ID_DIMENSION_COMPONENTES_CAPITAL_CONTABLE,
        ...
        /**
         * Constructor de la clase IXbrlEstadoVariacionesCapitalContableControllerCNBVScope
         *
         ...
         */
        constructor($scope: IXbrlEstadoVariacionesCapitalContableControllerCNBVScope, abaxXBRLServices: services.AbaxXBRLServices, $timeout: ng.ITimeoutService, $modal: ng.ui.bootstrap.IModalService) {
            var self = this;
    ...
    XbrlEstadoVariacionesCapitalContableCNBVController.$inject = ['$scope', 'abaxXBRLServices', '$timeout', '$modal'];
     ...
     * @version 1.0
     */
    export class InformacionDimensionesEVCC_CNBV {
        /**
     ...
     * @version 1.0
     */
    export interface IXbrlEstadoVariacionesCapitalContableControllerCNBVScope extends abaxXBRL.directives.IEditorFormatoDirectiveScope {

        /** La información dimensional del formato de captura del Estado de Variaciones al Capital Contable */
        informacionDimensiones: InformacionDimensionesEVCC_CNBV;
     ...
     * @version 1.0
     */
    export class XbrlEstadoVariacionesCapitalContableCNBV {
         ...
         */
        public static XbrlEstadoVariacionesCapitalContableCNBVDirective(): ng.IDirective {

            return {
                restrict: 'A',
                controller: XbrlEstadoVariacionesCapitalContableCNBVController
            };
        }
    }

    var estadoVariacionesModule: ng.IModule = angular.module('abaxXBRLEstadoVariacionesViewerCNBV', ['abaxXBRLViewer']);
    estadoVariacionesModule.controller('xbrlEstadoVariacionesCapitalContableCNBVController', abaxXBRL.templates.extensions.XbrlEstadoVariacionesCapitalContableCNBVController);
    estadoVariacionesModule.directive('xbrlEstadoVariacionesCapitalContableCnbv', abaxXBRL.templates.extensions.XbrlEstadoVariacionesCapitalContableCNBV.XbrlEstadoVariacionesCapitalContableCNBVDirective);
