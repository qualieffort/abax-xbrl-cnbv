...
module abaxXBRL.templates.extensions.dip {
    ...
    /**
       ...
       * @version 1.0
       */
    export class XbrlDistribucionIngresosProductoCNBVController {

        /** El scope del controlador */
        private $scope: IXbrlDistribucionIngresosProductoCNBVScope;
        ...
        public static get ESPACIO_NOMRES_DIMENSION_PRINCIPALES_MARCAS(): string { return 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05'; }

        /** El espacio de nombres de la dimensión tipificada línea de productos */
        public static get ESPACIO_NOMRES_DIMENSION_LINEA_PRODUCTOS(): string { return 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05'; }

        /** El espacio de nombres de la dimensión tipificada línea de productos */
        public static get ESPACIO_NOMRES_DIMENSION_TIPO_INGRESO(): string { return 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05'; }

        /** Contiene la plantilla que deberá usarse para definir un nuevo valor de la dimensión tipificada principales marcas */
        public static get TEMPLATE_VALOR_DIMENSION_PRINCIPALES_MARCAS(): string { return '<ifrs_mx-cor_20141205:PrincipalesMarcasDomain xmlns:ifrs_mx-cor_20141205="http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05">#valorDimensionMarcas</ifrs_mx-cor_20141205:PrincipalesMarcasDomain>'; }

        /** Contiene la plantilla que deberá usarse para definir un nuevo valor de la dimensión tipificada línea de productos */
        public static get TEMPLATE_VALOR_DIMENSION_LINEA_PRODUCTOS(): string { return '<ifrs_mx-cor_20141205:PrincipalesProductosOLineaDeProductosDomain xmlns:ifrs_mx-cor_20141205="http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05">#valorDimensionLineaProductos</ifrs_mx-cor_20141205:PrincipalesProductosOLineaDeProductosDomain>'; }

        /** Contiene el nombre completamente calificado de la dimensión implícita principales marcas */
        public static get QNAME_DIMENSION_PRINCIPALES_MARCAS(): string { return 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:PrincipalesMarcasEje'; }
        ...
        public static get QNAME_DIMENSION_LINEA_PRODUCTOS(): string { return 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:PrincipalesProductosOLineaDeProductosEje'; }
        ...
        public static get QNAME_DIMENSION_TIPO_DE_INGRESO(): string { return 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:TipoDeIngresoEje'; }
        ...
        **/
        private onReEvaluaElementosPlantillaSucess(): void {
            ...
            etiquetasCampoCaptura.xbrlCampoCaptura().promise().done(function () {
                ...
                setTimeout(function () { shared.service.AbaxXBRLUtilsService.reAjustaCeldasTabla(null); }, 333);
        ...
        **/
        public reEvaluaElementosPlantilla(): void {
            var $self = this;
            setTimeout(function () {
        ...
        **/
        private generaElementoMiembroTipificadoMarca(valorMiembro) {
            /*var plantillaXml = abaxXBRL.utils.XmlUtils.CrearJsonAPartirDeXml(XbrlDistribucionIngresosProductoCNBVController.TEMPLATE_VALOR_DIMENSION_PRINCIPALES_MARCAS);
            plantillaXml[XbrlDistribucionIngresosProductoCNBVController.NOMBRE_DIMENSION_PRINCIPALES_MARCAS][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_TEXT] = valorMiembro;
            ...
            return XbrlDistribucionIngresosProductoCNBVController.TEMPLATE_VALOR_DIMENSION_PRINCIPALES_MARCAS.replace("#valorDimensionMarcas", valorCodificadoXML);
        }
        ...
        **/
        private generaElementoMiembroTipificadoProducto(valorMiembro) {
            /*var plantillaXml = abaxXBRL.utils.XmlUtils.CrearJsonAPartirDeXml(XbrlDistribucionIngresosProductoCNBVController.TEMPLATE_VALOR_DIMENSION_LINEA_PRODUCTOS);
            plantillaXml[XbrlDistribucionIngresosProductoCNBVController.NOMBRE_DIMENSION_LINEA_PRODUCTOS][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_TEXT] = valorMiembro;
            return abaxXBRL.utils.XmlUtils.CrearXmlAPartirDeJson(plantillaXml);*/
            var valorCodificadoXML = shared.service.AbaxXBRLUtilsService.xmlEncode(valorMiembro);
            return XbrlDistribucionIngresosProductoCNBVController.TEMPLATE_VALOR_DIMENSION_LINEA_PRODUCTOS.replace("#valorDimensionLineaProductos", valorCodificadoXML);
        }
        ...
        **/
        private actualizaElementoMiembroTipificado(contextosIds: Array<string>, valorDimensionAnterior: string, valorDimensionNuevo: string, esMarca: boolean) {
            ...
            var scope: IXbrlDistribucionIngresosProductoCNBVScope = self.$scope;
        ...
        **/
        ...
        private crearContextoDeDistribucionDeIngresos(valorDimensionMarca: string, valorDimensionProducto: string, qNameMiembroTipoIngreso: string, idItemMiembroTipoIngreso: string, emisora: string, esquemaEmisora: string, tipo: number, fechaInicio: string, fechaFin?: string): abaxXBRL.model.Contexto {
            ...
            dimensionTipoIngreso.QNameDimension = XbrlDistribucionIngresosProductoCNBVController.QNAME_DIMENSION_TIPO_DE_INGRESO;
            dimensionTipoIngreso.IdDimension = XbrlDistribucionIngresosProductoCNBVController.ID_DIMENSION_TIPO_DE_INGRESO;
            ...
            dimensionMarca.QNameDimension = XbrlDistribucionIngresosProductoCNBVController.QNAME_DIMENSION_PRINCIPALES_MARCAS;
            dimensionMarca.IdDimension = XbrlDistribucionIngresosProductoCNBVController.ID_DIMENSION_PRINCIPALES_MARCAS;
            dimensionMarca.ElementoMiembroTipificado = this.generaElementoMiembroTipificadoMarca(valorDimensionMarca);
            dimensionMarca.CreatTextoElementoMiembroTipificado();
            ...
            dimensionProducto.QNameDimension = XbrlDistribucionIngresosProductoCNBVController.QNAME_DIMENSION_LINEA_PRODUCTOS;
            dimensionProducto.IdDimension = XbrlDistribucionIngresosProductoCNBVController.ID_DIMENSION_LINEA_PRODUCTOS;
            dimensionProducto.ElementoMiembroTipificado = this.generaElementoMiembroTipificadoProducto(valorDimensionProducto);
            dimensionProducto.CreatTextoElementoMiembroTipificado();
        ...
        **/
        private inicializaIndices(fechaInicioPeriodo: string, fechaFinTrimestre: string, emisora: string, esquemaEmisora: string): void {
            ...
            valoresDimensionComparar.push(new abaxXBRL.model.DimensionInfo().deserialize({
                Explicita: false,
                QNameDimension: XbrlDistribucionIngresosProductoCNBVController.QNAME_DIMENSION_LINEA_PRODUCTOS
            }));
            valoresDimensionComparar.push(new abaxXBRL.model.DimensionInfo().deserialize({
                Explicita: false,
                QNameDimension: XbrlDistribucionIngresosProductoCNBVController.QNAME_DIMENSION_PRINCIPALES_MARCAS
            }));
            valoresDimensionComparar.push(new abaxXBRL.model.DimensionInfo().deserialize({
                Explicita: true,
                QNameDimension: XbrlDistribucionIngresosProductoCNBVController.QNAME_DIMENSION_TIPO_DE_INGRESO
            }));
                            ...
                            for (var k = 0; k < copiaComparar.length; k++) {
                                if (contexto.ValoresDimension[j].EsInfoMismaDimension(copiaComparar[k])) {
                                    ...
                                    if (!contexto.ValoresDimension[j].Explicita) {
                                        ...
                                        var nombreDimensionEvaluada = XbrlDistribucionIngresosProductoCNBVController.NOMBRE_DIMENSION_PRINCIPALES_MARCAS;
                                        var espacionNombresDimensionEvaluada = XbrlDistribucionIngresosProductoCNBVController.ESPACIO_NOMRES_DIMENSION_PRINCIPALES_MARCAS;

                                        if (elementoMiembroTipificado[nombreDimensionEvaluada]) {
                                            if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_PREFIX]) {
                                                var prefijo = elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_PREFIX];
                                                if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_PREFIJO_ELEMENTO_XMLNS + prefijo]) {
                                                    var xmlns = elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_PREFIJO_ELEMENTO_XMLNS + prefijo];
                                                    if (xmlns === espacionNombresDimensionEvaluada) {
                                                        if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_TEXT]) {
                                                            valorDimensionMarca = elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_TEXT];
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        var nombreDimensionEvaluada = XbrlDistribucionIngresosProductoCNBVController.NOMBRE_DIMENSION_LINEA_PRODUCTOS;
                                        var espacionNombresDimensionEvaluada = XbrlDistribucionIngresosProductoCNBVController.ESPACIO_NOMRES_DIMENSION_LINEA_PRODUCTOS;
                                        ...
                                        if (elementoMiembroTipificado[nombreDimensionEvaluada]) {
                                            if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_PREFIX]) {
                                                ...
                                                if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_PREFIJO_ELEMENTO_XMLNS + prefijo]) {
                                                    ...
                                                    if (xmlns === espacionNombresDimensionEvaluada) {
                                                        if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_TEXT]) {
                                                            valorDimensionProducto = elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBVController.X2JS_ELEMENTO_TEXT];
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (contexto.ValoresDimension[j].QNameDimension === XbrlDistribucionIngresosProductoCNBVController.QNAME_DIMENSION_TIPO_DE_INGRESO) {
        ...
        private eliminarProductoDefinitivamente(valorDimensionMarca: string, valorDimensionProducto: string, fechaInicioTrimestre: string, fechaFinTrimestre: string): void {
            ...
            self.abaxService.reevaluaFormulasPorConcepto("ifrs_mx-cor_20141205_ImporteDeIngresos");
        }
                        ...
                        DefinicionVariables: {
                            'variable1': new model.DefinicionVariableFormula().deserialize({
                                ...
                                FiltrosDimension: [
                                    {
                                        Explicita: true,
                                        QNameDimension: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:TipoDeIngresoEje',
                                        IdDimension: 'ifrs_mx-cor_20141205_TipoDeIngresoEje',
                                        QNameItemMiembro: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:IngresosTotalesMiembro',
                                        IdItemMiembro: 'ifrs_mx-cor_20141205_IngresosTotalesMiembro'
                                    },
                                    {
                                        Explicita: false,
                                        QNameDimension: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:PrincipalesMarcasEje',
                                        IdDimension: 'ifrs_mx-cor_20141205_PrincipalesMarcasEje',
                                        ElementoMiembroTipificado: '<ifrs_mx-cor_20141205:PrincipalesMarcasDomain xmlns:ifrs_mx-cor_20141205=\"http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05\">' + $util.xmlEncode(marca) + '</ifrs_mx-cor_20141205:PrincipalesMarcasDomain>',
                                        ValorTipificado: $util.xmlEncode(marca)
                                    },
                                    {
                                        Explicita: false,
                                        QNameDimension: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:PrincipalesProductosOLineaDeProductosEje',
                                        IdDimension: 'ifrs_mx-cor_20141205_PrincipalesProductosOLineaDeProductosEje',
                                        ElementoMiembroTipificado: '<ifrs_mx-cor_20141205:PrincipalesProductosOLineaDeProductosDomain xmlns:ifrs_mx-cor_20141205=\"http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05\">' + $util.xmlEncode(producto) + '</ifrs_mx-cor_20141205:PrincipalesProductosOLineaDeProductosDomain>',
                                ...
                                FiltrosDimension: [
                                    {
                                        ...
                                        QNameDimension: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:TipoDeIngresoEje',
                                        IdDimension: 'ifrs_mx-cor_20141205_TipoDeIngresoEje',
                                        QNameItemMiembro: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:IngresosNacionalesMiembro',
                                ...
                                FiltrosDimension: [
                                    {
                                        ...
                                        QNameDimension: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:TipoDeIngresoEje',
                                        IdDimension: 'ifrs_mx-cor_20141205_TipoDeIngresoEje',
                                        QNameItemMiembro: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:IngresosPorExportacionMiembro',
                                ...
                                FiltrosDimension: [
                                    {
                                        ...
                                        QNameDimension: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:TipoDeIngresoEje',
                                        IdDimension: 'ifrs_mx-cor_20141205_TipoDeIngresoEje',
                                        QNameItemMiembro: 'http://cnbv.gob.mx/ifrs_mx-cor_20141205/full_ifrs_mx-cor_2014-12-05:IngresosDeSubsidiariasEnElExtranjeroMiembro',
        ...
        **/
        private init(): void {
            ...
            var self: XbrlDistribucionIngresosProductoCNBVController = this;
            var scope: IXbrlDistribucionIngresosProductoCNBVScope = self.$scope;
            ...
            scope.agregarValorDimensionMarca = function (): void {
                ...
                var nombreNuevoElemento: string = XbrlDistribucionIngresosProductoCNBVController.PREFIJO_NOMBRE_MARCA_DEFECTO;
                ...
                if (valoresDimensionMaraca) {
                    while ($.inArray(nombreNuevoElemento, valoresDimensionMaraca) != -1) {
                        nombreNuevoElemento = XbrlDistribucionIngresosProductoCNBVController.PREFIJO_NOMBRE_MARCA_DEFECTO + ' ' + intentos++;
                    }
                }
            ...
            scope.agregarValorDimensionProducto = function (valorDimensionMarca: string): void {
                ...
                var intentos: number = 1;
                var nombreNuevoElemento: string = XbrlDistribucionIngresosProductoCNBVController.PREFIJO_NOMBRE_PRODUCTO_DEFECTO;
                ...
                if (valoresDimensionProducto) {
                    while ($.inArray(nombreNuevoElemento, valoresDimensionProducto) != -1) {
                        nombreNuevoElemento = XbrlDistribucionIngresosProductoCNBVController.PREFIJO_NOMBRE_PRODUCTO_DEFECTO + ' ' + intentos++;
                    }
                }
            ...
            scope.obtenerIdContexto = function (valorDimensionMarca: string, valorDimensionProducto: string, tipoIngreso: string, idItemMiembroTipoIngreso: string): string {
                ...
                var qNameMiembroTipoIngreso = XbrlDistribucionIngresosProductoCNBVController.ESPACIO_NOMRES_DIMENSION_TIPO_INGRESO + ':' + tipoIngreso;
                        ...
                        if (v) {
                            ...
                            scope.$apply(function () {
                                ...
                                for (var indexPorducto: number = 0; indexPorducto < scope.valoresDimensionProductoPorMarca[valorDimensionMarca].length; indexPorducto++) {
                                    nombresProductosEliminar.push(scope.valoresDimensionProductoPorMarca[valorDimensionMarca][indexPorducto]);
                                }

                                for (var indexPorducto: number = 0; indexPorducto < nombresProductosEliminar.length; indexPorducto++) {
                                    var valorDimensionProducto = nombresProductosEliminar[indexPorducto];
                                    self.eliminarProductoDefinitivamente(valorDimensionMarca, valorDimensionProducto, fechaInicioPeriodo, fechaFinTrimestre);
                                }
         ...
         */
        constructor($scope: IXbrlDistribucionIngresosProductoCNBVScope, abaxXBRLServices: services.AbaxXBRLServices, $timeout: ng.ITimeoutService) {
    ...
    XbrlDistribucionIngresosProductoCNBVController.$inject = ['$scope', 'abaxXBRLServices', '$timeout'];
     ...
     * @version 1.0
     */
    export interface IXbrlDistribucionIngresosProductoCNBVScope extends ng.IScope {
    ...
    **/
    export class XbrlDistribucionIngresosProductoCNBV {

        public static XbrlDistribucionIngresosProductoCNBVDirective(): ng.IDirective {

            return {
                restrict: 'A',
                controller: XbrlDistribucionIngresosProductoCNBVController
            };
        }
    }
    ...
    export class XbrlCampoTextoGenericoDipCNBV {
        ...
        **/
        public static XbrlCampoTextoGenericoDipCNBVDirective(): ng.IDirective {
            return {
                restrict: 'E',
                scope: {
                    xbrlValor: '@',
                ...
                controller: XbrlCampoTextoGenericoDipCNBVController,
                ...
                link: function ($scope: IXbrlCampoTextoGenericoDipCNBVDirectiveCNBVScope, element: ng.IAugmentedJQuery, attrs: ng.IAttributes, controllers: any) {
    ...
    export class XbrlCampoTextoGenericoDipCNBVController {
        /**Scope de la directiva de campo de texto generico. **/
        private $scope: IXbrlCampoTextoGenericoDipCNBVDirectiveCNBVScope;
        ...
        * @param $scope Scope de la directiva de campo de texto generico.
         **/
        constructor($scope: IXbrlCampoTextoGenericoDipCNBVDirectiveCNBVScope, $element: ng.IAugmentedJQuery) {
            this.$scope = $scope;
    ...
    XbrlCampoTextoGenericoDipCNBVController.$inject = ['$scope', '$element'];



    var distribucionIngresosModule: ng.IModule = angular.module('abaxXBRLDistribucionIngresosModuleCNBV', ['abaxXBRLViewer']);
    distribucionIngresosModule.directive('xbrlDistribucionIngresosCnbv', abaxXBRL.templates.extensions.dip.XbrlDistribucionIngresosProductoCNBV.XbrlDistribucionIngresosProductoCNBVDirective);
    distribucionIngresosModule.controller('xbrlDistribucionIngresosProductoCNBVController', abaxXBRL.templates.extensions.dip.XbrlDistribucionIngresosProductoCNBVController);

    distribucionIngresosModule.directive('xbrlCampoTextoGenericoDipCnbv', abaxXBRL.templates.extensions.dip.XbrlCampoTextoGenericoDipCNBV.XbrlCampoTextoGenericoDipCNBVDirective);
    distribucionIngresosModule.controller('xbrlCampoTextoGenericoDipCNBVController', abaxXBRL.templates.extensions.dip.XbrlCampoTextoGenericoDipCNBVController);
