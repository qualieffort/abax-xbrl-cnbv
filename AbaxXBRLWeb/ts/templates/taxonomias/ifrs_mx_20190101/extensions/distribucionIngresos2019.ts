...
module abaxXBRL.templates.extensions.dip {
    ...
    /**
       ...
       * @version 1.0
       */
    export class XbrlDistribucionIngresosProductoCNBV2019Controller {

        /** El scope del controlador */
        private $scope: IXbrlDistribucionIngresosProductoCNBV2019Scope;
        ...
        **/
        private generaElementoMiembroTipificadoMarca(valorMiembro) {
            ...
            return XbrlDistribucionIngresosProductoCNBV2019Controller.TEMPLATE_VALOR_DIMENSION_PRINCIPALES_MARCAS.replace("#valorDimensionMarcas", valorCodificadoXML);
        }
        ...
        **/
        private generaElementoMiembroTipificadoProducto(valorMiembro) {
            ...
            return abaxXBRL.utils.XmlUtils.CrearXmlAPartirDeJson(plantillaXml);*/
            var valorCodificadoXML = shared.service.AbaxXBRLUtilsService.xmlEncode(valorMiembro);
            return XbrlDistribucionIngresosProductoCNBV2019Controller.TEMPLATE_VALOR_DIMENSION_LINEA_PRODUCTOS.replace("#valorDimensionLineaProductos", valorCodificadoXML);
        }
        ...
        **/
        private actualizaElementoMiembroTipificado(contextosIds: Array<string>, valorDimensionAnterior: string, valorDimensionNuevo: string, esMarca: boolean) {
            ...
            var scope: IXbrlDistribucionIngresosProductoCNBV2019Scope = self.$scope;
        ...
        **/
        ...
        private crearContextoDeDistribucionDeIngresos(valorDimensionMarca: string, valorDimensionProducto: string, qNameMiembroTipoIngreso: string, idItemMiembroTipoIngreso: string, emisora: string, esquemaEmisora: string, tipo: number, fechaInicio: string, fechaFin?: string): abaxXBRL.model.Contexto {
            ...
            dimensionTipoIngreso.QNameDimension = XbrlDistribucionIngresosProductoCNBV2019Controller.QNAME_DIMENSION_TIPO_DE_INGRESO;
            dimensionTipoIngreso.IdDimension = XbrlDistribucionIngresosProductoCNBV2019Controller.ID_DIMENSION_TIPO_DE_INGRESO;
            ...
            dimensionMarca.QNameDimension = XbrlDistribucionIngresosProductoCNBV2019Controller.QNAME_DIMENSION_PRINCIPALES_MARCAS;
            dimensionMarca.IdDimension = XbrlDistribucionIngresosProductoCNBV2019Controller.ID_DIMENSION_PRINCIPALES_MARCAS;
            ...
            dimensionProducto.QNameDimension = XbrlDistribucionIngresosProductoCNBV2019Controller.QNAME_DIMENSION_LINEA_PRODUCTOS;
            dimensionProducto.IdDimension = XbrlDistribucionIngresosProductoCNBV2019Controller.ID_DIMENSION_LINEA_PRODUCTOS;
        ...
        **/
        private inicializaIndices(fechaInicioPeriodo: string, fechaFinTrimestre: string, emisora: string, esquemaEmisora: string): void {
            ...
            valoresDimensionComparar.push(new abaxXBRL.model.DimensionInfo().deserialize({
                Explicita: false,
                QNameDimension: XbrlDistribucionIngresosProductoCNBV2019Controller.QNAME_DIMENSION_LINEA_PRODUCTOS
            }));
            valoresDimensionComparar.push(new abaxXBRL.model.DimensionInfo().deserialize({
                Explicita: false,
                QNameDimension: XbrlDistribucionIngresosProductoCNBV2019Controller.QNAME_DIMENSION_PRINCIPALES_MARCAS
            }));
            valoresDimensionComparar.push(new abaxXBRL.model.DimensionInfo().deserialize({
                Explicita: true,
                QNameDimension: XbrlDistribucionIngresosProductoCNBV2019Controller.QNAME_DIMENSION_TIPO_DE_INGRESO
            }));
                            ...
                            for (var k = 0; k < copiaComparar.length; k++) {
                                if (contexto.ValoresDimension[j].EsInfoMismaDimension(copiaComparar[k])) {
                                    ...
                                    if (!contexto.ValoresDimension[j].Explicita) {
                                        ...
                                        var nombreDimensionEvaluada = XbrlDistribucionIngresosProductoCNBV2019Controller.NOMBRE_DIMENSION_PRINCIPALES_MARCAS;
                                        var espacionNombresDimensionEvaluada = XbrlDistribucionIngresosProductoCNBV2019Controller.ESPACIO_NOMRES_DIMENSION_PRINCIPALES_MARCAS;

                                        if (elementoMiembroTipificado[nombreDimensionEvaluada]) {
                                            if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_ELEMENTO_PREFIX]) {
                                                var prefijo = elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_ELEMENTO_PREFIX];
                                                if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_PREFIJO_ELEMENTO_XMLNS + prefijo]) {
                                                    var xmlns = elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_PREFIJO_ELEMENTO_XMLNS + prefijo];
                                                    if (xmlns === espacionNombresDimensionEvaluada) {
                                                        if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_ELEMENTO_TEXT]) {
                                                            valorDimensionMarca = elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_ELEMENTO_TEXT];
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        var nombreDimensionEvaluada = XbrlDistribucionIngresosProductoCNBV2019Controller.NOMBRE_DIMENSION_LINEA_PRODUCTOS;
                                        var espacionNombresDimensionEvaluada = XbrlDistribucionIngresosProductoCNBV2019Controller.ESPACIO_NOMRES_DIMENSION_LINEA_PRODUCTOS;
                                        ...
                                        if (elementoMiembroTipificado[nombreDimensionEvaluada]) {
                                            if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_ELEMENTO_PREFIX]) {
                                                ...
                                                if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_PREFIJO_ELEMENTO_XMLNS + prefijo]) {
                                                    ...
                                                    if (xmlns === espacionNombresDimensionEvaluada) {
                                                        if (elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_ELEMENTO_TEXT]) {
                                                            valorDimensionProducto = elementoMiembroTipificado[nombreDimensionEvaluada][XbrlDistribucionIngresosProductoCNBV2019Controller.X2JS_ELEMENTO_TEXT];
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (contexto.ValoresDimension[j].QNameDimension === XbrlDistribucionIngresosProductoCNBV2019Controller.QNAME_DIMENSION_TIPO_DE_INGRESO) {
        ...
        **/
        private init(): void {
            ...
            var self: XbrlDistribucionIngresosProductoCNBV2019Controller = this;
            var scope: IXbrlDistribucionIngresosProductoCNBV2019Scope = self.$scope;
            ...
            scope.agregarValorDimensionMarca = function (): void {
                ...
                var nombreNuevoElemento: string = XbrlDistribucionIngresosProductoCNBV2019Controller.PREFIJO_NOMBRE_MARCA_DEFECTO;
                ...
                if (valoresDimensionMaraca) {
                    while ($.inArray(nombreNuevoElemento, valoresDimensionMaraca) != -1) {
                        nombreNuevoElemento = XbrlDistribucionIngresosProductoCNBV2019Controller.PREFIJO_NOMBRE_MARCA_DEFECTO + ' ' + intentos++;
                    }
                }
            ...
            scope.agregarValorDimensionProducto = function (valorDimensionMarca: string): void {
                ...
                var intentos: number = 1;
                var nombreNuevoElemento: string = XbrlDistribucionIngresosProductoCNBV2019Controller.PREFIJO_NOMBRE_PRODUCTO_DEFECTO;
                ...
                if (valoresDimensionProducto) {
                    while ($.inArray(nombreNuevoElemento, valoresDimensionProducto) != -1) {
                        nombreNuevoElemento = XbrlDistribucionIngresosProductoCNBV2019Controller.PREFIJO_NOMBRE_PRODUCTO_DEFECTO + ' ' + intentos++;
                    }
                }
            ...
            scope.obtenerIdContexto = function (valorDimensionMarca: string, valorDimensionProducto: string, tipoIngreso: string, idItemMiembroTipoIngreso: string): string {
                ...
                var qNameMiembroTipoIngreso = XbrlDistribucionIngresosProductoCNBV2019Controller.ESPACIO_NOMRES_DIMENSION_TIPO_INGRESO + ':' + tipoIngreso;
         ...
         */
        constructor($scope: IXbrlDistribucionIngresosProductoCNBV2019Scope, abaxXBRLServices: services.AbaxXBRLServices, $timeout: ng.ITimeoutService) {
    ...
    XbrlDistribucionIngresosProductoCNBV2019Controller.$inject = ['$scope', 'abaxXBRLServices', '$timeout'];
     ...
     * @version 1.0
     */
    export interface IXbrlDistribucionIngresosProductoCNBV2019Scope extends ng.IScope {
    ...
    **/
    export class XbrlDistribucionIngresosProductoCNBV2019 {

        public static XbrlDistribucionIngresosProductoCNBV2019Directive(): ng.IDirective {

            return {
                restrict: 'A',
                controller: XbrlDistribucionIngresosProductoCNBV2019Controller
            };
        }
    }
    ...
    export interface IXbrlCampoTextoDtoDipCNBV2019 {
        /**Valor de campo de texto. **/
        valor: string;
    }

    /**Campo de captura de texto generico. **/
    export interface IXbrlCampoTextoGenericoDipDirectiveCNBV2019Scope extends ng.IScope {

        /** Valor con el que se inicializa el campo de captura.**/
        xbrlValor: string;

        /** El valor temporal que almacena los posibles cambios al modelo */
        valorTemporal: IXbrlCampoTextoDtoDipCNBV2019;
    ...
    export class XbrlCampoTextoGenericoDipCNBV2019 {
        ...
        **/
        public static XbrlCampoTextoGenericoDipCNBV2019Directive(): ng.IDirective {
            return {
                restrict: 'E',
                scope: {
                    xbrlValor: '@',
                ...
                controller: XbrlCampoTextoGenericoDipCNBV2019Controller,
                templateUrl: "ts/templates/taxonomias/ifrs_mx_20190101/extensions/template-xbrl-texto-generico.html?version=" + root.AbaxXBRLConstantesRoot.VERSION_APP.version,
                link: function ($scope: IXbrlCampoTextoGenericoDipDirectiveCNBV2019Scope, element: ng.IAugmentedJQuery, attrs: ng.IAttributes, controllers: any) {
    ...
    export class XbrlCampoTextoGenericoDipCNBV2019Controller {
        /**Scope de la directiva de campo de texto generico. **/
        private $scope: IXbrlCampoTextoGenericoDipDirectiveCNBV2019Scope;
        ...
        * @param $scope Scope de la directiva de campo de texto generico.
         **/
        constructor($scope: IXbrlCampoTextoGenericoDipDirectiveCNBV2019Scope, $element: ng.IAugmentedJQuery) {
            this.$scope = $scope;
    ...
    XbrlCampoTextoGenericoDipCNBV2019Controller.$inject = ['$scope', '$element'];



    var distribucionIngresosModule: ng.IModule = angular.module('abaxXBRLDistribucionIngresosModuleCNBV2019', ['abaxXBRLViewer']);
    distribucionIngresosModule.directive('xbrlDistribucionIngresosCnbv2019', abaxXBRL.templates.extensions.dip.XbrlDistribucionIngresosProductoCNBV2019.XbrlDistribucionIngresosProductoCNBV2019Directive);
    distribucionIngresosModule.controller('xbrlDistribucionIngresosProductoCNBV2019Controller', abaxXBRL.templates.extensions.dip.XbrlDistribucionIngresosProductoCNBV2019Controller);

    distribucionIngresosModule.directive('xbrlCampoTextoGenericoDipCnbv2019', abaxXBRL.templates.extensions.dip.XbrlCampoTextoGenericoDipCNBV2019.XbrlCampoTextoGenericoDipCNBV2019Directive);
    distribucionIngresosModule.controller('xbrlCampoTextoGenericoDipCNBV2019Controller', abaxXBRL.templates.extensions.dip.XbrlCampoTextoGenericoDipCNBV2019Controller);
