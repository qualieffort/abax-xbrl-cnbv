...
module abaxXBRL.templates.extensions {
    ...
    export class XbrlDesgloseCreditosController {
        ...
        **/
        private inicializaCaposEdicionDimensioInsitucion(): ng.IPromise<void> {
            ...
            abaxXBRL.plugins.XbrlPluginUtils
                .cargarPlantillaYReemplazarVariables('ts/templates/taxonomias/ifrs_mx_20141205/extensions/template-xbrl-campo-dimension-institucion.html?version=' + root.AbaxXBRLConstantesRoot.VERSION_APP.version,
                variablesPlantilla,
        ...
        */
        private inicializarDetalleInstituciones(): ng.IPromise<void> {
            ...
            var $deferred = $util.creatPromiseDeferred<void>();
            var variablesPlantilla = new Array<{ llave: string; valor: string; }>();
            abaxXBRL.plugins.XbrlPluginUtils.cargarPlantillaYReemplazarVariables('ts/templates/taxonomias/ifrs_mx_20141205/extensions/template-xbrl-detalle-desglose-institucion.html?version=' + root.AbaxXBRLConstantesRoot.VERSION_APP.version,
                variablesPlantilla,
                function (plantilla: JQuery) {
        ...
        */
        ...
        private init(): void {
            ...
            self.$scope.actualizarValorDimensionInstitucion = function (valorDimensionAnterior: string, valorDimensionNuevo: string): boolean {
                ...
                plantillaXml[XbrlDesgloseCreditosController.NOMBRE_DIMENSION_INSTITUCION][XbrlDesgloseCreditosController.X2JS_ELEMENTO_TEXT] = valorDimensionNuevo;
    ...
    var desgloseCreditosModule: ng.IModule = angular.module('abaxXBRLDesgloseCreditosViewer', ['abaxXBRLViewer', 'pascalprecht.translate','tmh.dynamicLocale']);
