module abaxXBRL.componentes.controllers {
    ...
    **/
    export interface AbaxXBRLAsignaFiduciariosScope extends IAbaxXBRLInicioScope {
        /**
    ...
    **/
    export class AbaxXBRLAsignaFiduciariosController {
        /** 
       * El scope del controlador 
       **/
        private $scope: AbaxXBRLAsignaFiduciariosScope;
        ...
        **/
        private determinaNoAsignados(): void {
            ...
            for (var indexExistente = 0; indexExistente < listaExistentes.length; indexExistente++) {
                ...
                var esFideicomitente = listaExistentes[indexExistente].Fideicomitente;
                ...
                if (!estaAsignado && esFideicomitente) {
        ...
        **/
        private obtenAsignados(): void {
            ...
            var url = AbaxXBRLConstantes.OBTEN_FIDUCIARIOS_ASIGNADOS_PATH;
        ...
        **/
        private obtenExistentes(): void {
            var self = this;
            var scope = self.$scope;
            var url = AbaxXBRLConstantes.CONSULTA_FIDUCIARIOS_PATH;
       ...
       **/
        private guardar() {
            ...
            var url = AbaxXBRLConstantes.ASIGNA_FIDUCIARIOS_PATH;
       ...
       **/
        ...
        **/
        private cargarEmisoras(empresaYaSeleccionado = false): void {
            var self: AbaxXBRLAsignaFiduciariosController = this;
            var scope: AbaxXBRLAsignaFiduciariosScope = self.$scope;
        ...
        **/
        constructor($scope: AbaxXBRLAsignaFiduciariosScope, abaxXBRLRequestService: shared.service.AbaxXBRLRequestService, $state: ng.ui.IStateService) {
            this.$scope = $scope;
    ...
    AbaxXBRLAsignaFiduciariosController.$inject = ['$scope', 'abaxXBRLRequestService', '$state'];
} 