module abaxXBRL.componentes.controllers {
    ...
    **/
    export interface AbaxXBRLAsignaGrupoAEmpresaScope extends IAbaxXBRLInicioScope {
        /**
        ...
        **/
        guardando: boolean;
        /**
        * Listener a ejecutar cuando cambia el valor seleccionado del filtro del propietario
        **/
    ...
    **/
    export class AbaxXBRLAsignaGruposAEmpresaEmpresasController {
        /** 
       * El scope del controlador 
       **/
        private $scope: AbaxXBRLAsignaGrupoAEmpresaScope;
        ...
        **/
        private obtenAsignados(): void {
            ...
            var url = AbaxXBRLConstantes.OBTEN_GRUPOS_EMPRESA_ASIGNADOS_EMPRESA_PATH;
        ...
        **/
        private obtenExistentes(): void {
            var self = this;
            var scope = self.$scope;
            var url = AbaxXBRLConstantes.OBTEN_GRUPOS_EMPRESA_ASIGNABLES_EMPRESA_PATH;
       ...
       **/
        private guardar() {
            ...
            var url = AbaxXBRLConstantes.GUARDA_ASINGACION_GRUPO_EMPRESA_A_EMPRESA_PATH;
       ...
       **/
        ...
        **/
        private cargaComboPropietarios(): void {
            var self: AbaxXBRLAsignaGruposAEmpresaEmpresasController = this;
            var scope: AbaxXBRLAsignaGrupoAEmpresaScope = self.$scope;
            ...
            var url = AbaxXBRLConstantes.OBTEN_EMPRESAS_COMBO_PATH;
        ...
        **/
        constructor($scope: AbaxXBRLAsignaGrupoAEmpresaScope, abaxXBRLRequestService: shared.service.AbaxXBRLRequestService, $state: ng.ui.IStateService) {
            this.$scope = $scope;
    ...
    AbaxXBRLAsignaGruposAEmpresaEmpresasController.$inject = ['$scope', 'abaxXBRLRequestService', '$state'];
} 