module abaxXBRL.componentes.controllers {
    ...
    /**
    * Declaracion del Scope para consulta de Administradores
    *
    * @author Angel de Jesús Cruz Gómez
    * @version 1.0
    */
    export interface AbaxXBRLAdministradoresScope extends IAbaxXBRLInicioScope {
        /**
    ...
    * @version 1.0
    */
    export class AbaxXBRLAdministradoresController {
        /** El Scope del Controlador **/
        private $scope: AbaxXBRLAdministradoresScope;
        ...
        private cargarEmisoras(): void {
            var self: AbaxXBRLAdministradoresController = this;
        ...
        **/
        private onCargarEmisorasSuccess(resultado: Array<shared.modelos.IEmisora>): void {
            var scope: AbaxXBRLAdministradoresScope = this.$scope;
        ...
        **/
        private configurarOpcionesDataTable() {
            ...
            var onOpcionesSucess = function (opcioensAjax) {
                ...
                opcionesDt.withOption("sDom", "<'row'<'col-sm-6'l><'col-sm-6'>r>t<'row'<'col-sm-6'i>><'#paginacionTablaAdministradores'p>");
                ...
                opcionesDt.withOption("columnDefs", [
                    {
                        "targets": [0, 1, 2, 4, 5, 6, 7, 8, 9, 10, 12, 16, 17, 18],
                ...
                opcionesDt.withOption("columns", [
                    ...
                    { "data": "TipoConsejero" },
                    { "data": "Auditoria" },
                    { "data": "PracticasSocietarias" },
                    { "data": "EvaluacionCompensacion" },
                    { "data": "Otros" },
                    { "data": "FechaDesignacion" },
                    { "data": "TipoAsamblea" },
                    { "data": "PeriodoElecto" },
                    { "data": "Cargo" },
                    { "data": "TiempoOcupandoCargo" },
                    { "data": "ParticipacionAccionaria" },
                    { "data": "Sexo" },
                    { "data": "InfoAdicional" }
                ]);
                ...
                opcioensAjax.url = AbaxXBRLConstantes.OBTENER_ADMINISTRADORES;
        ...
        **/
        ...
        private ejecutaExportaAExcel(params: { [id: string]: any }) {
            ...
            self.abaxXBRLRequestService.post(AbaxXBRLConstantes.EXPORTA_ADMINISTRADORES_A_EXCEL, params, true).then(onSuccess, onError).finally(onFinally);
        }
        ...
        **/
        private onDescargaArchivoSuccess(resultado: any) {
            ...
            saveAs(blob, 'administradores.xls');
        }
        ...
        **/
        constructor($scope: AbaxXBRLAdministradoresScope, abaxXBRLRequestService: shared.service.AbaxXBRLRequestService, $state: ng.ui.IStateService ) {
            this.$scope = $scope; 
    ...
    AbaxXBRLAdministradoresController.$inject = ['$scope', 'abaxXBRLRequestService', '$state'];
    ...
    export class XbrlValidacionListaSeleccionMultiple {
        ...
        public static XbrlValidacionListaSeleccionMultipleDirective(): ng.IDirective {
            ...
            return {
                ...
                replace: false,
                transclude: false,
                link: function ($scope: AbaxXBRLAdministradoresScope, element: ng.IAugmentedJQuery, attrs: ng.IAttributes, myCtrl: any) {
