    ...
    **/
    export interface IAbaxXBRLListadoConsultasRepositorioScope extends IAbaxXBRLInicioScope {
        ...
        **/
        ...
        /**
        * Re dirige a lapantalla de consulta.
        * @param elemento Elemento con la información a presentar.
        **/
        irConsulta(elemento: shared.modelos.IConsultaRepositorioCnbv): void;
        /**
        ...
        * @param elemento Elemento con el detalle a presentar.
        **/
    ...
    **/
    export class AbaxXBRLListadoConsultasRepositorioController {
        ...
        **/
        ...
        /**
        * Nombre del estado vista que presenta la vista para editar y ejecutar la consulta.
        **/
        private estadoVistaEditarConsulta: string = 'inicio.consultaXBRL';
        ...
        * @param elemento Elemento con la información a presentar.
        **/
        private irConsulta(elemento: shared.modelos.IConsultaRepositorioCnbv): void
        {
            var $util = this.$util;
            $util.setAtributoTemporal(AbaxXBRLConstantes.ATRIBUTO_ELEMENTO_EDITAR, elemento);
            $util.cambiarEstadoVistasA(this.estadoVistaEditarConsulta);
        }
        /**
        * Método que intenta eliminar el elemento indicado del catálogo.
        * @param elemento Elemento a eliminar.
        ...
        private onEliminarSucess(data: shared.modelos.IResultadoOperacion): void
        {
            ...
            if (data) {
                ...
                if (data.Resultado == true) {
                    msg = util.getValorEtiqueta('MENSAJE_EXITO_ELIMINAR_CONSULTA_REPOSITORIO', { "NOMBRE": data.Mensaje });
                    util.ExitoBootstrap(msg);
                } else {
                    msg = util.getValorEtiqueta('MENSAJE_ERROR_ELIMINAR_CONSULTA_REPOSITORIO', { "NOMBRE": data.Mensaje });
        ...
        **/
        private ajustaValoresElementos(): void {
            ...
            var etiquetaPibca: string = $util.getValorEtiqueta("ETIQUETA_PUBLICA");
            var etiquetaPrivada: string = $util.getValorEtiqueta("ETIQUETA_PRIVADA");
            var claseIconoPublico: string = 'fa fa-eye';
            var claseIconoPrivado: string = 'fa fa-eye-slash';
            for (indexElemento = 0; indexElemento < listaElementos.length; indexElemento++) {

                var elemento = listaElementos[indexElemento];
                elemento.FechaCreacion = moment(elemento.FechaCreacion).format('DD/MM/YYYY');
                elemento.DescripcionTipo = elemento.Publica ? etiquetaPibca : etiquetaPrivada;
                //console.log(elemento);
                elemento.ClaseIcono = elemento.Publica ? claseIconoPublico : claseIconoPrivado;
            }
        }
        ...
        **/
        private init():void
        {
            ...
            $scope.irConsulta = function (elemento: shared.modelos.IConsultaRepositorioCnbv): void { $self.irConsulta(elemento); };
