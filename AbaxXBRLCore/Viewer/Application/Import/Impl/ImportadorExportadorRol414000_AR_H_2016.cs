...
{
    class ImportadorExportadorRol414000_AR_H_2016 : IImportadorExportadorRolDocumento
    {

        private IDictionary<String, String> ConceptosHipercuboPorHoja = new Dictionary<String, String>()
        {
            {"414000-Circulacion","ar_pros_CharacteristicsOfTheCurrentListedSeriesTable"},
            {"414000-Inversionista","ar_pros_InvestorRelationshipTable"},
            {"414000-Fundador","ar_pros_FoundingShareholdersTable"},
            {"414000-Proyectos","ar_pros_MainProjectsOrFinancingPurposesTable"},
            {"414000-Valores","ar_pros_AdditionalValuesTable"},
        };
