...
{
    /// <summary>
    /// Exportador generico para roles compustos exclusivamente de notas.
    /// </summary>
    class ImportadorExportadorRolNotas : ImportadorExportadorRolDocumentoPlantilla
    {
        
        /// <summary>
        /// Clave del rol de presentación que será utlizado para presentar la estrucutara.
        /// </summary>
        public string RolPresentacion { get; set; }
