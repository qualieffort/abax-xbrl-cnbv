...
namespace AbaxXBRLCore.Viewer.Application.Import.Impl
{
    ...
    /// </summary>
    class ImportadorExportadorRol800500Bmv2014: ImportadorExportadorRolDocumentoPlantilla
    {
        private const string _rol800500 = "http://bmv.com.mx/role/ifrs/ias_1_2014-03-05_role-800500";
        public override void ExportarRolADocumentoWord(Document word, Section seccionActual, DocumentoInstanciaXbrlDto instancia, string rol, IDefinicionPlantillaXbrl plantillaDocumento, string claveIdioma)
        {
            ...
            var rolPresentacion = instancia.Taxonomia.RolesPresentacion.FirstOrDefault(x => x.Uri.Equals(_rol800500));
