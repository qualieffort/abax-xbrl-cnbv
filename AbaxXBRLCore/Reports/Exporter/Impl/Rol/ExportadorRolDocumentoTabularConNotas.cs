...
namespace AbaxXBRLCore.Reports.Exporter.Impl.Rol
{
    ...
    /// del rol que sean numéricos, si encuentra un concepto del tipo de dato text block entonces se escribe el hecho en un solo renglón completo
    /// 
    /// </summary>
    public class ExportadorRolDocumentoTabularConNotas : ExportadorRolDocumentoBase
    {
        
        /// <summary>
        /// Constructor por defecto.
        /// </summary>
        public ExportadorRolDocumentoTabularConNotas()
            : base()
        { 
