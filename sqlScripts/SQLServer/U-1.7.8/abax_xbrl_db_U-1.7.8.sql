...
BEGIN
ALTER TABLE [dbo].[Unidad] ADD  CONSTRAINT [FK_Unidad_DocumentoInstancia] FOREIGN KEY([IdDocumentoInstancia]) REFERENCES [dbo].[DocumentoInstancia] ([IdDocumentoInstancia])
END
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
