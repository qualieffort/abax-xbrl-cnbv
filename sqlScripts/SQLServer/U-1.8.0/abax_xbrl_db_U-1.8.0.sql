...
GO
IF NOT EXISTS(SELECT * FROM dbo.sysobjects WHERE NAME LIKE 'DF__Categoria__Borra%' AND type = 'D')
BEGIN
...
GO
IF NOT EXISTS(SELECT * FROM dbo.sysobjects WHERE NAME LIKE 'DF__Facultad__Borrad%' AND type = 'D')
BEGIN
