...
CREATE TABLE "ABAX_XBRL"."ArchivoTaxonomiaXbrl" (
   "IdArchivoTaxonomiaXbrl" NUMBER(19) NOT NULL,
...
CREATE TABLE "ABAX_XBRL"."DtsDocumentoInstancia" (
   "IdDtsDocumentoInstancia" NUMBER(19) NOT NULL,
   "IdDocumentoInstancia" NUMBER(19) NOT NULL,
...
CREATE TABLE "ABAX_XBRL"."GrupoUsuariosRol" (
   "IdGrupoUsuariosRol" NUMBER(19) NOT NULL,
...
CREATE TABLE "ABAX_XBRL"."NotaAlPie" (
   "IdNotaAlPie" NUMBER(19) NOT NULL,
...
CREATE TABLE "ABAX_XBRL"."RegistroAuditoria" (
   "IdRegistroAuditoria" NUMBER(19) NOT NULL,
   "Fecha" TIMESTAMP NOT NULL,
   "IdUsuario" NUMBER(19) NOT NULL,
   "IdModulo" NUMBER(19) NOT NULL,
   "IdAccionAuditable" NUMBER(19) NOT NULL,
...
CREATE TABLE "ABAX_XBRL"."RolFacultad" (
   "IdRolFacultad" NUMBER(19) NOT NULL,
   "IdRol" NUMBER(19) NOT NULL,
   "IdFacultad" NUMBER(19) NOT NULL
);
...
CREATE TABLE "ABAX_XBRL"."UsuarioDocumentoInstancia" (
   "IdusuarioDocumentoInstancia" NUMBER(19) NOT NULL,
   "IdUsuario" NUMBER(19) NOT NULL,
   "IdDocumentoInstancia" NUMBER(19) NOT NULL,
...
CREATE TABLE "ABAX_XBRL"."UsuarioEmpresa" (
   "IdUsuarioEmpresa" NUMBER(19) NOT NULL,
   "IdUsuario" NUMBER(19) NOT NULL,
   "IdEmpresa" NUMBER(19) NOT NULL
);
...
CREATE TABLE "ABAX_XBRL"."UsuarioGrupo" (
   "IdUsuarioGrupo" NUMBER(19) NOT NULL,
   "IdUsuario" NUMBER(19) NOT NULL,
   "IdGrupoUsuarios" NUMBER(19) NOT NULL
);
...
CREATE TABLE "ABAX_XBRL"."UsuarioRol" (
   "IdUsuarioRol" NUMBER(19) NOT NULL,
   "IdUsuario" NUMBER(19) NOT NULL,
   "IdRol" NUMBER(19) NOT NULL
);
...
CREATE TABLE "ABAX_XBRL"."VersionDocumentoInstancia" (
   "IdVersionDocumentoInstancia" NUMBER(19) NOT NULL,
   "IdDocumentoInstancia" NUMBER(19) NOT NULL,
...
CREATE SEQUENCE "ABAX_XBRL"."IdAlerta_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdArchivoTaxonomiaXbrl_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdContexto_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdDocumentoInstancia_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdDtsDocumentoInstancia_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdEmpresa_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdGrupoUsuarios_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdGrupoUsuariosRol_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdHecho_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdNotaAlPie_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdRegistroAuditoria_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdRol_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdRolFacultad_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdTaxonomiaXbrl_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdUnidad_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdUsuario_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdUsuarioDocumento_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdUsuarioEmpresa_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdUsuarioGrupo_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdUsuarioRol_SEQ";
CREATE SEQUENCE "ABAX_XBRL"."IdVersionDocumento_SEQ";
...
CREATE OR REPLACE TRIGGER "ABAX_XBRL"."Alerta_TR" BEFORE INSERT ON "ABAX_XBRL"."Alerta" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdAlerta_SEQ".NEXTVAL INTO   :new."IdAlerta" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."ArchivoTaxonomiaXbrl_TR" BEFORE INSERT ON "ABAX_XBRL"."ArchivoTaxonomiaXbrl" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdArchivoTaxonomiaXbrl_SEQ".NEXTVAL INTO   :new."IdArchivoTaxonomiaXbrl" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."Contexto_TR" BEFORE INSERT ON "ABAX_XBRL"."Contexto" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdContexto_SEQ".NEXTVAL INTO   :new."IdContexto" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."DocumentoInstancia_TR" BEFORE INSERT ON "ABAX_XBRL"."DocumentoInstancia" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdDocumentoInstancia_SEQ".NEXTVAL INTO   :new."IdDocumentoInstancia" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."DtsDocumentoInstancia_TR" BEFORE INSERT ON "ABAX_XBRL"."DtsDocumentoInstancia" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdDtsDocumentoInstancia_SEQ".NEXTVAL INTO   :new."IdDtsDocumentoInstancia" FROM   dual; END; 
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."Empresa_TR" BEFORE INSERT ON "ABAX_XBRL"."Empresa" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdEmpresa_SEQ".NEXTVAL INTO   :new."IdEmpresa" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."GrupoUsuarios_TR" BEFORE INSERT ON "ABAX_XBRL"."GrupoUsuarios" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdGrupoUsuarios_SEQ".NEXTVAL INTO   :new."IdGrupoUsuarios" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."GrupoUsuariosRol_TR" BEFORE INSERT ON "ABAX_XBRL"."GrupoUsuariosRol" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdGrupoUsuariosRol_SEQ".NEXTVAL INTO   :new."IdGrupoUsuariosRol" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."Hecho_TR" BEFORE INSERT ON "ABAX_XBRL"."Hecho" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdHecho_SEQ".NEXTVAL INTO   :new."IdHecho" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."NotaAlPie_TR" BEFORE INSERT ON "ABAX_XBRL"."NotaAlPie" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdNotaAlPie_SEQ".NEXTVAL INTO   :new."IdNotaAlPie" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."RegistroAuditoria_TR" BEFORE INSERT ON "ABAX_XBRL"."RegistroAuditoria" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdRegistroAuditoria_SEQ".NEXTVAL INTO   :new."IdRegistroAuditoria" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."Rol_TR" BEFORE INSERT ON "ABAX_XBRL"."Rol" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdRol_SEQ".NEXTVAL INTO   :new."IdRol" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."RolFacultad_TR" BEFORE INSERT ON "ABAX_XBRL"."RolFacultad" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdRolFacultad_SEQ".NEXTVAL INTO   :new."IdRolFacultad" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."TaxonomiaXbrl_TR" BEFORE INSERT ON "ABAX_XBRL"."TaxonomiaXbrl" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdTaxonomiaXbrl_SEQ".NEXTVAL INTO   :new."IdTaxonomiaXbrl" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."Unidad_TR" BEFORE INSERT ON "ABAX_XBRL"."Unidad" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdUnidad_SEQ".NEXTVAL INTO   :new."IdUnidad" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."Usuario_TR" BEFORE INSERT ON "ABAX_XBRL"."Usuario" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdUsuario_SEQ".NEXTVAL INTO   :new."IdUsuario" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."UsuarioDocumento_TR" BEFORE INSERT ON "ABAX_XBRL"."UsuarioDocumentoInstancia" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdUsuarioDocumento_SEQ".NEXTVAL INTO   :new."IdusuarioDocumentoInstancia" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."UsuarioEmpresa_TR" BEFORE INSERT ON "ABAX_XBRL"."UsuarioEmpresa" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdUsuarioEmpresa_SEQ".NEXTVAL INTO   :new."IdUsuarioEmpresa" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."UsuarioGrupo_TR" BEFORE INSERT ON "ABAX_XBRL"."UsuarioGrupo" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdUsuarioGrupo_SEQ".NEXTVAL INTO   :new."IdUsuarioGrupo" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."UsuarioRol_TR" BEFORE INSERT ON "ABAX_XBRL"."UsuarioRol" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdUsuarioRol_SEQ".NEXTVAL INTO   :new."IdUsuarioRol" FROM   dual; END;
/

CREATE OR REPLACE TRIGGER "ABAX_XBRL"."VersionDocumento_TR" BEFORE INSERT ON "ABAX_XBRL"."VersionDocumentoInstancia" FOR EACH ROW BEGIN SELECT "ABAX_XBRL"."IdVersionDocumento_SEQ".NEXTVAL INTO   :new."IdVersionDocumentoInstancia" FROM   dual; END;
/
