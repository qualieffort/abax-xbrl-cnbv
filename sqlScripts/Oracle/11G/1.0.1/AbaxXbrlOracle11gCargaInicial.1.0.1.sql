...
INSERT INTO "ABAX_XBRL"."Facultad" ("IdFacultad", "Nombre", "Descripcion", "IdCategoriaFacultad", "Borrado") VALUES (70, 'Importar hechos de documento instancia', 'Facultad para importar hechos de otro documento de instancia.', 6, 0);
INSERT INTO "ABAX_XBRL"."Facultad" ("IdFacultad", "Nombre", "Descripcion", "IdCategoriaFacultad", "Borrado") VALUES (300, 'Migrar versión documentos instancia', 'Facultad migrar los contextos de los documentos de instancia en una nueva veresión.', 6, 0);
INSERT INTO "ABAX_XBRL"."Facultad" ("IdFacultad", "Nombre", "Descripcion", "IdCategoriaFacultad", "Borrado") VALUES (64, 'Configuración de consultas', 'Facultad para lka configuración y ejecución de consultas',6,0);
...
INSERT INTO "ABAX_XBRL"."RolFacultad" ("IdRol", "IdFacultad")  (SELECT "ABAX_XBRL"."Rol"."IdRol", 70 FROM "ABAX_XBRL"."Rol" WHERE "ABAX_XBRL"."Rol"."Nombre" = 'Usuario Negocio');
